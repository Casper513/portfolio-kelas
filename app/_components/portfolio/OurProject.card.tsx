        ...
        <div className="relative overflow-hidden group">
          <Card>
            <CardContent className="p-0">
              ...
              <CardFooter className="absolute bottom-0 left-0 w-full p-4 bg-white bg-opacity-90 transform translate-y-full transition-transform duration-300 ease-in-out group-hover:translate-y-0">
                <Button>View</Button>
              </CardFooter>
            </CardContent>
          </Card>
